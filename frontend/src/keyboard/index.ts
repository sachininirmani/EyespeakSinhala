...
import { eyespeak_v3 } from "./layouts/eyespeak_v3";
import { eyespeak_v4 } from "./layouts/eyespeak_v4";
import { wijesekara } from "./layouts/wijesekara";

export const ALL_KEYBOARDS = [eyespeak_v1, eyespeak_v2, eyespeak_v3, eyespeak_v4, wijesekara] as const;
