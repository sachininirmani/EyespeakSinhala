    ...
    return (
        <div className="card" style={{ marginTop: 12, width: "100%" }}>
            ...
            >
                <div>
                    ...
                    <div style={{ color: "#64748b", fontSize: 13, marginTop: 2 }}>
                        Configure layouts and interaction modes.
                    </div>
                </div>
            ...
            {open && (
                <div
                    className="row"
                    style={{ gap: 18, flexWrap: "wrap", marginTop: 10 }}
                >
                    <div>
                        ...
                        {layouts.map((lid) => (
                            ...
                            >
                                <input
                                    ...
                                    onChange={(e) =>
                                        toggleLayout(lid, e.target.checked)
                                    }
                                />{" "}
                                {lid.toUpperCase()}
                            </label>
                    ...
                    <div>
                        ...
                        {(
                            ["dwell", "hybrid_c", "dwell_free_c"] as InteractionId[]
                        ).map((iid) => (
                            <label
                                key={iid}
                                style={{ display: "block", fontSize: 13 }}
                            >
                                <input
                                    ...
                                    onChange={(e) =>
                                        toggleInteraction(iid, e.target.checked)
                                    }
                                />{" "}
                                {iid}
                            </label>
                        ...
                        >
                            Note: Action mappings are fixed per interaction mode
                            for this study to keep participant training consistent.
                        </div>
                    </div>
                </div>
            )}
